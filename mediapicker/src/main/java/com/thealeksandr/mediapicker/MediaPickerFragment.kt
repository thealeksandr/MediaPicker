...
class MediaPickerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        val columns = arrayOf(MediaStore.Files.FileColumns.MEDIA_TYPE, MediaStore.Files.FileColumns._ID)
        ...
        /*val videoColumns = arrayOf(MediaStore.Video.Media.DURATION, MediaStore.Images.Media._ID)
